...
namespace DMM.Pages
{
    public partial class Page_Suppliers : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        TB_Suppliers tbAdd = new TB_Suppliers();
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            DMM.Pages.Add_Suppliers add = new Add_Suppliers();
            add.id = 0;
        ...
        private void btn_edt_click_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(id > 0)
                {
                    ...
                    DMM.Pages.Add_Suppliers add = new Add_Suppliers();// نفس كود الاضافة مع بعض تعديلات الخفيفة
                    add.id = id;
        ...
        private void btn_log_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (id > 0)
                {
                    db = new DBDMMEntities();
                    tbAdd = db.TB_Suppliers.Where(x => x.ID == id).FirstOrDefault();
                    DMM.AddPage.Log_Supplier add = new AddPage.Log_Supplier();// نفس كود الاضافة مع بعض تعديلات الخفيفة
